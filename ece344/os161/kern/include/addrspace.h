...
//vnode pointer
	...
	size_t filesize_data;
	u_int32_t off_data;
	size_t filesize_text;
	u_int32_t off_text; 
	int **firstpt;
...
int               as_define_region(struct addrspace *as, 
				   vaddr_t vaddr, size_t sz, size_t filesize,
				   int readable, 
				   int writeable,
				   int executable, struct vnode *v, u_int32_t offset);
