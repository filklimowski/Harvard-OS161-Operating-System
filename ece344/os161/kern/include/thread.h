 ...
 * Interrupts must be disabled.
 */
void thread_cvsleep(const void *addr);
...
/*
 * Wakes up only one thread in the sleeper list
*/
void thread_wakeup_head(const void *addr, struct queue *cv_queue);

/*
 * Used for main to replicate fork and wait
*/
int
