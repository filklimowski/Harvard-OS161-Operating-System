...
printchar.o: ${S}/userprog/printchar.c
	${COMPILE.c} ${S}/userprog/printchar.c
SRCS+=${S}/userprog/printchar.c
OBJS+=printchar.o
...
get_pid.o: ${S}/userprog/get_pid.c
	${COMPILE.c} ${S}/userprog/get_pid.c
SRCS+=${S}/userprog/get_pid.c
OBJS+=get_pid.o

wait.o: ${S}/userprog/wait.c
	${COMPILE.c} ${S}/userprog/wait.c
SRCS+=${S}/userprog/wait.c
OBJS+=wait.o
...
sbrk.o: ${S}/userprog/sbrk.c
	${COMPILE.c} ${S}/userprog/sbrk.c
SRCS+=${S}/userprog/sbrk.c
OBJS+=sbrk.o
